...
export const ModalCreateStudent = () => {
  ...
  return (
    <div className="modal fade" id="modalCreateStudent" data-bs-backdrop="static" aria-hidden="true">
