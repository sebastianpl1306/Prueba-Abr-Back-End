...
export const ModalUpdateTeacher = ({ initialState }) => {
  const { identification, name, lastName, age, address, phone, formState, onInputChange, onResetForm } = useForm(initialState);
  const { startUpdateTeacher } = useTeachers();

  const submitForm = (event) =>{
    event.preventDefault();
    startUpdateTeacher(formState);
    onResetForm();
    $('#modalUpdateTeacher').modal('hide');
  }

  return (
    <div className="modal fade" id="modalUpdateTeacher" data-bs-backdrop="static" aria-hidden="true">
